						...
						<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
							<div class="top_bar_right ml-auto">					
								<div class="top_bar_social">
									<span class="top_bar_title project_desc">A shared forum for all extracurricular clubs of any college.</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="header_content d-flex flex-row align-items-center justify-content-start">
						...
						<nav class="main_nav_contaner">
							<ul class="main_nav">
								...
								<li <?php echo $active=="events"?' class="active" ':""; ?>><a href="events.php">Events</a></li>
								<li <?php echo $active=="ecert"?' class="active" ':""; ?>><a href="ecert.php">E-Certificates</a></li>
								<li <?php echo $active=="contact"?' class="active" ':""; ?>><a href="contact us.php">Contact Us</a></li>
							</ul>
						</nav>
