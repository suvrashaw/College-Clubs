							...
							<div class="language_slider_container">
								<div class="owl-carousel owl-theme language_slider">
									<div class="owl-item language_item">
										<a href="club.php">
											<div class="flag"><img src="images/iete_logo.png" alt=""></div>
											<div class="lang_name">IETE Society</div>
										</a>
									</div>
									<div class="owl-item language_item">
										<a href=>
											<div class="flag"><img src="https://ahalia.ac.in/wp-content/uploads/2020/01/iic-logo.png" alt=""></div>
											<div class="lang_name">IIC Society</div>
										</a>
									</div>								
									<div class="owl-item language_item">
										<a href=>
				...
				<div class="container">
					...
					<div class="row events_row">
						<div class="col-lg-4 event_col">
							<div class="event">
								<div class="event_image"><img src="images/iete.png" alt=""></div>
								...
								<div class="event_body d-flex flex-row align-items-center justify-content-start">
									<div class="event_title"><a href="event.php">Project Exhibition</a></div>
									<div class="event_tag ml-auto">IETE UEMK</div>
								</div>
							</div>
						</div>
						<div class="col-lg-4 event_col">
							<div class="event">
								<div class="event_image"><img src="images/code.png" alt=""></div>
								<div class="event_date d-flex flex-column align-items-center justify-content-center">
									<div class="event_day">27</div>
									<div class="event_month">Jun</div>
								</div>
								<div class="event_body d-flex flex-row align-items-center justify-content-start">
									<div class="event_title"><a href>Project II</a></div>
