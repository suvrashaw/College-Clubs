				...
				<div class="row row-lg-eq-height">
					<div class="col-lg-9">
						<div class="tab_panels">
									...
									<div class="row">
										<div class="col-lg-9">
											<div class="tabs d-flex flex-row align-items-center justify-content-start">
												...
												<div class="tab">featured attendees</div>
							...
							<div class="faqs">
								<div class="panel_title">Event Details</div>
									...
									<div class="review_title_container d-flex flex-row align-items-start justify-content-start">
										<div class="review_title d-flex flex-row align-items-center justify-content-center">
											...
											<div class="review_author">
												<div class="review_author_name"><a href="#">Suvra Shaw</a></div>
												<div class="review_date">27 May 2021, 09:30 am</div>
											</div>
										</div>
								...
								<div class="review">
									<div class="review_title_container d-flex flex-row align-items-start justify-content-start">
										<div class="review_title d-flex flex-row align-items-center justify-content-center">
											...
											<div class="review_author">
												<div class="review_author_name"><a href="#">Avirup Roy</a></div>
												<div class="review_date">27 May 2021, 09:30 am</div>
											</div>
										</div>
										<div class="review_stars ml-auto"><div class="rating_r rating_r_4 review_rating"><i></i><i></i><i></i><i></i><i></i></div></div>
								...
								<div class="review">
									<div class="review_title_container d-flex flex-row align-items-start justify-content-start">
										<div class="review_title d-flex flex-row align-items-center justify-content-center">
											<div class="review_author_image"><div><i class="fa fa-user" aria-hidden="true"></i></div></div>
											<div class="review_author">
												<div class="review_author_name"><a href="#">Lahama Banerjee</a></div>
												<div class="review_date">27 May 2021, 09:30 am</div>
											</div>
										</div>
										<div class="review_stars ml-auto"><div class="rating_r rating_r_4 review_rating"><i></i><i></i><i></i><i></i><i></i></div></div>
					...
					<div class="col-lg-3">
						<div class="sidebar">
							...
							<div class="sidebar_top"><a href="#">RSVP For this Event</a></div>
							<div class="sidebar_content">
							<div class="sidebar_section features">
								<div class="sidebar_title">Event Details</div>
								<div class="features_content">
									<ul class="features_list">
										<li class="d-flex flex-row align-items-start justify-content-start">
											<div class="feature_title"><i class="fa fa-clock-o" aria-hidden="true"></i><span>Date</span></div>
											<div class="feature_text ml-auto">27 May 2021</div>
										</li>
										<li class="d-flex flex-row align-items-start justify-content-start">
											<div class="feature_title"><i class="fa fa-bell" aria-hidden="true"></i><span>Time</span></div>
											<div class="feature_text ml-auto">09:30 am</div>
										</li>
										<li class="d-flex flex-row align-items-start justify-content-start">
											<div class="feature_title"><i class="fa fa-id-badge" aria-hidden="true"></i><span>Mode</span></div>
											<div class="feature_text ml-auto">Google Meet</div>
										</li>
									</ul>
								</div>
							</div>
								...
								<div class="like_items">
									<div class="like_item d-flex flex-row align-items-end justify-content-start">
										<div class="like_title_container">
											<div class="like_title">Basketball Cup</div>
											<div class="like_subtitle">Sports Club</div>
										</div>
									</div>
									<div class="like_item d-flex flex-row align-items-end justify-content-start">
										<div class="like_title_container">
											<div class="like_title">Jazz Up</div>
											<div class="like_subtitle">Dance Club</div>
										</div>
									</div>
									<div class="like_item d-flex flex-row align-items-end justify-content-start">
										<div class="like_title_container">
											<div class="like_title">CulFest</div>
											<div class="like_subtitle">CulFest Community</div>
										</div>
									</div>
								</div>
							</div>
